# ########### Note ###########
# This is the `jupyter nbconvert --to script` output
# ############################
# !/usr/bin/env python
# coding: utf-8
...
BATCH_SIZE = 8
NUM_CLASSES = 4
INPUT_SHAPE = (3, 224, 224) #resnet18
...
import os
directory_path = "/Users/redge/Library/CloudStorage/OneDrive-UniversityofCalgary/School/MEng/Winter2024/enel645/ENSF-611-ENEL-645/ENEL 645/A2/small_dataset/Test/Green"
...
# image_sizes = get_image_sizes_from_subfolders(root_directory)
...
# import os
# root_directory = "/Users/redge/Library/CloudStorage/OneDrive-UniversityofCalgary/School/MEng/Winter2024/enel645/ENSF-611-ENEL-645/ENEL 645/A2/small_dataset"
# def getimage_sizes_from_subfolders(root_directory):
#     image_sizes = []

#     # Iterate through all files in the specified directory and its subdirectories
#     for folder, , files in os.walk(root_directory):
